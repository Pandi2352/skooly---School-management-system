...
/**
 * Filters on the left, search on the right. RecordsCard supplies the row; the second line holds the
 * date range, which only earns its space once someone is looking for a particular week.
 */
